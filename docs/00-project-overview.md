...
`sprite-animations` — библиотека для 2D sprite-анимации в вебе на `canvas`, ориентированная на внутреннее использование и полный контроль над runtime-поведением. Первая версия включает npm-пакет и dev playground для настройки, проверки и сохранения конфигурации анимации.
...
Подготовить рабочий MVP библиотеки, которая умеет загружать регулярный sprite sheet, воспроизводить анимацию на `canvas`, управлять таймингом и позиционированием, а также поддерживает настройку параметров через playground.
